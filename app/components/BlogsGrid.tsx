          ...
          <div className="p-6 flex flex-col flex-grow">
            <div className="flex items-center justify-between mb-2">
              ...
              {blog.verified && (
                <span
                  title="Verified"
                  className="inline-flex items-center gap-1 bg-blue-100 text-blue-700 rounded-full px-3 py-0.5 text-xs font-semibold select-none"
                >
                  <svg
            ...
            {/* {blog.paraphrased && (
                <div className="text-sm italic text-blue-800 bg-blue-50 rounded p-2 mt-3 border border-blue-200 select-text">
                  {blog.paraphrased}
                </div>
              )} */}
