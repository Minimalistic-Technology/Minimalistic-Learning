    ...
    <section className="relative flex items-center justify-center overflow-hidden">
      ...
      <AnimatedBackground
        blobs={[
          {
            className:
              "absolute top-1/4 left-1/4 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-blue-400/20 rounded-full blur-3xl",
            animation: {
              x: [0, 100, 0],
              y: [0, 50, 0],
              scale: [1, 1.2, 1],
          ...
          {
            className:
              "absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-cyan-400/20 rounded-full blur-3xl",
            animation: {
              x: [0, -100, 0],
              y: [0, -50, 0],
              scale: [1, 1.3, 1],
          ...
          {
            className:
              "absolute top-1/2 left-1/2 w-40 h-40 sm:w-56 sm:h-56 md:w-80 md:h-80 bg-sky-400/15 rounded-full blur-3xl",
            animation: {
              rotate: [0, 360],
              scale: [1, 1.1, 1],
            },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20 lg:py-32">
        <div className="grid gap-8 sm:gap-10 md:gap-12 md:grid-cols-2 md:items-center">
          ...
          >
            {/* Badge */}
            <Badge
              title="Minimalistic Learning Platform"
          ...
          >
            ...
            {/* Main Card */}
            <div className="relative rounded-2xl md:rounded-3xl border border-blue-200/50 dark:border-blue-700/50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-2xl ring-2 ring-blue-500/20 dark:ring-blue-700/20 overflow-hidden">
              {/* Gradient Background */}
              <div className="aspect-square relative overflow-hidden">
                ...
                <AnimatedBackground
                  blobs={[
                    {
                      className:
                        "absolute top-10 right-10 w-24 h-24 rounded-full bg-gradient-to-br from-blue-400/30 to-cyan-400/30 blur-2xl",
                      animation: {
                        x: [0, 20, 0],
                        y: [0, 20, 0],
                        rotate: [0, 10, 0],
                    ...
                    {
                      className:
                        "absolute bottom-10 left-10 w-32 h-32 rounded-full bg-gradient-to-br from-sky-400/30 to-blue-400/30 blur-2xl",
                      animation: {
                        x: [0, -20, 0],
                        y: [0, -20, 0],
                        rotate: [0, -10, 0],
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center p-6 md:p-8 text-center">
                  <div className="inline-flex items-center justify-center size-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-xl md:rounded-2xl bg-gradient-to-r from-blue-600 via-sky-600 to-cyan-600 mb-4 md:mb-6 shadow-xl">
              ...
              {/* Stats Card */}
              <motion.div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 rounded-xl md:rounded-2xl border border-slate-200/50 dark:border-slate-700/50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl p-3 md:p-4 lg:p-5 shadow-xl ring-1 ring-black/5">
