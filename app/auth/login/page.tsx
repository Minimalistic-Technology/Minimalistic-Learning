      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-purple-200/50 ring-2 ring-purple-500/20 overflow-hidden dark:bg-slate-900/95 dark:border-purple-700/50">
          ...
          <div className="bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-600 px-8 py-12 text-center relative overflow-hidden">
            ...
            <div className="inline-flex items-center justify-center w-20 h-20 bg-white/30 backdrop-blur-sm rounded-2xl mb-4 relative z-10 ring-2 ring-white/50">
              <svg
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-4 py-3.5 border rounded-xl transition-all duration-300 ${
                      errors.email
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`block w-full pl-10 pr-12 py-3.5 border rounded-xl transition-all duration-300 ${
                      errors.password
                        ? "border-red-300 bg-red-50/50 focus:ring-red-500 focus:border-red-500 dark:bg-red-950/20 dark:border-red-800"
                        : "border-slate-200 bg-slate-50/50 focus:ring-[#2563eb] focus:border-[#2563eb] dark:bg-slate-800/50 dark:border-slate-700"
                    } focus:outline-none focus:ring-2 text-gray-900 placeholder-gray-400 dark:text-slate-100 dark:placeholder-slate-400`}
